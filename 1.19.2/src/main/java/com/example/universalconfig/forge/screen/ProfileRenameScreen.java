...
public final class ProfileRenameScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(width / 2 - 104, height - 32, 100, 20,
                Component.translatable("screen.universal_config.rename"), button -> rename()));
        addRenderableWidget(new Button(width / 2 + 4, height - 32, 100, 20,
                Component.translatable("screen.universal_config.back"), button -> minecraft.setScreen(parent)));
    ...
    public void render(PoseStack context, int mouseX, int mouseY, float delta) {
        ...
        drawString(context, font, Component.translatable("screen.universal_config.profile_rename_label"),
                left, 44, 0xDDDDDD);
