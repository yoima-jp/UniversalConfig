...
public final class ApplyScheduledScreen extends Screen {
    ...
    public void render(PoseStack context, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredString(context, font, Component.translatable(firstLineKey), width / 2, textY, MUTED_TEXT_COLOR);
        drawCenteredString(context, font, Component.translatable(secondLineKey), width / 2, textY + 18, MUTED_TEXT_COLOR);
