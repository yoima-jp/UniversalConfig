...
public final class ProfileCreateScreen extends Screen {
    ...
    public void render(PoseStack context, int mouseX, int mouseY, float delta) {
        ...
        drawString(context, font, Component.translatable("screen.universal_config.profile_name_label"),
                formLeft, 40, 0xDDDDDD);
        drawString(context, font, Component.translatable("screen.universal_config.profile_description_label"),
                formLeft, 80, 0xDDDDDD);
        drawString(context, font, Component.translatable("screen.universal_config.profile_save_contents"),
