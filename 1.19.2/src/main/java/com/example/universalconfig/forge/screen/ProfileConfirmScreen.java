...
public final class ProfileConfirmScreen extends Screen {
    ...
    private void drawPanel(PoseStack context) {
        ...
        int y = panelTop() + 16;
        drawString(context, font, Component.literal(safe(manifest.name)), x, y, 0xFFFFFFFF);
        y += 18;
        ...
        drawString(context, font, Component.translatable("screen.universal_config.included_settings"), x, y, 0xFFFFFFFF);
        y += 16;
    ...
    private int drawInclude(PoseStack context, boolean included, String key, int x, int y) {
        if (included) {
            ...
            drawString(context, font, Component.translatable(key), x + 14, y, 0xFFFFFFFF);
