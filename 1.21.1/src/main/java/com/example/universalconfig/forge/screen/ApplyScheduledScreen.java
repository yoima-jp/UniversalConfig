...
public final class ApplyScheduledScreen extends Screen {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredString(font, title, width / 2, panelTop + 16, TEXT_COLOR);
        ...
        context.drawCenteredString(font, Component.translatable(firstLineKey), width / 2, textY, MUTED_TEXT_COLOR);
        context.drawCenteredString(font, Component.translatable(secondLineKey), width / 2, textY + 18, MUTED_TEXT_COLOR);
    ...
    private void drawWrappedCenteredText(GuiGraphics context, Component message, int startY, int color) {
        ...
        for (FormattedCharSequence line : lines) {
            ...
            context.drawString(font, line, lineX, lineY, color);
            lineY += 10;
        }
    }
