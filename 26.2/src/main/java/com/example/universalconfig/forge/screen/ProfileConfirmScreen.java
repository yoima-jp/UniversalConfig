...
public final class ProfileConfirmScreen extends Screen {
    ...
    private void drawPanel(GuiGraphicsExtractor context) {
        ...
        int y = panelTop() + 16;
        context.text(font, Component.literal(safe(manifest.name)), x, y, 0xFFFFFFFF);
        y += 18;
        ...
        context.text(font, Component.translatable("screen.universal_config.included_settings"), x, y, 0xFFFFFFFF);
        y += 16;
    ...
    private void drawDetails(GuiGraphicsExtractor context, int x, int detailsTop, int contentRight) {
    ...
    private int drawInclude(GuiGraphicsExtractor context, boolean included, String key, int x, int y) {
        if (included) {
            ...
            context.text(font, Component.translatable(key), x + 14, y, 0xFFFFFFFF);
    ...
    private void drawBorderedRect(GuiGraphicsExtractor context, int left, int top, int right, int bottom, int fill) {
