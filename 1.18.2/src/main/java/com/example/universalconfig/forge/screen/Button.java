...
/**
 * 1.20で導入されたButton.Builder相当を1.18系へ提供する。
...
class Button extends net.minecraft.client.gui.components.Button {
    ...
    public void renderButton(PoseStack graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Vanilla 1.18 samples width / 2 pixels from each side of a 200px source. Responsive buttons wider than
        // 200px therefore sample outside widgets.png and appear as broken bars. Stretch the two valid 100px halves.
