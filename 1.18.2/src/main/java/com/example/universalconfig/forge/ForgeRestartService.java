...
public final class ForgeRestartService {
    ...
    public static void scheduleRestartAfterCurrentProcessExit() throws UniversalConfigException {
        try {
            ...
            // Forge 1.18 loads classes from SecureJarHandler's virtual union filesystem. Supplying the loader-resolved
            // physical Jar keeps the standalone restart helper independent of CodeSource URI implementation details.
