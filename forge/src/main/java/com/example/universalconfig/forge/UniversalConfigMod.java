...
public final class UniversalConfigMod {
    ...
    private void registerPictureInPictureRenderers(RegisterPictureInPictureRendererEvent event) {
        event.register(new ProfileIconRenderer());
    }
    ...
    public void onClientTick(TickEvent.ClientTickEvent.Post event) {
        ...
        while (openKey.consumeClick()) {
            if (minecraft.gui.screen() == null || minecraft.gui.screen() instanceof TitleScreen) {
                minecraft.setScreenAndShow(new ProfileListScreen(minecraft.gui.screen()));
            }
        }
    }
    ...
    public void onScreenInit(ScreenEvent.Init.Post event) {
        ...
        IconButton button = new IconButton(TITLE_SCREEN_BUTTON_MARGIN, y,
                ignored -> minecraft.setScreenAndShow(new ProfileListScreen(event.getScreen())), narration);
